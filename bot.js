...
client.on("message", message => {
  if (message.author.bot) return;           //filter out bot responses
  if (message.channel.type !== "text") return; //restrict to text channel commands
  if (message.content.indexOf(client.customSettings.prefix) !== 0) return; // look for bot prefix in messages
